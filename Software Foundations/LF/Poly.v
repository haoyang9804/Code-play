...
Lemma lemma_poly_1 : forall (X:Type), forall (l1 l2:list X), forall n:X,
  (n :: l1) ++ l2 = n :: (l1 ++ l2).
Proof.
  intros. simpl. 
  destruct l2 as [|n' l2'].
...
Proof.
  ...
  - simpl. reflexivity.
  - simpl. 
    assert (H: forall (X Y : Type) (f : X -> Y) (li : list X) (n : X),
    map f (li ++ [n]) = (map f li) ++ [f n]). 
    {
      intros. induction li as [|n' li' IHli'].
      - simpl. reflexivity.
