...
Theorem try1 : forall n : nat, 
  0 + n = n.
Proof.
  intros. reflexivity.  Qed.

Theorem try2 : forall n : nat, 
  n = 0 + n.
Proof.
  intros. reflexivity.  Qed.  
...
Proof.
  ...
  - simpl. rewrite -> IHn'. 
    assert (H : forall a b : nat, S (a + b) = a + S b).
    {
...
Proof.
  ...
  induction n as [|n' IHn'].
  - simpl. reflexivity. 
  - rewrite -> IHn'. simpl. Print negb.
  assert (H: forall a:bool, negb (negb a) = a).
  {
    intros. destruct a eqn:Eqa.
    - simpl. reflexivity.
    - simpl. reflexivity.
  }
  rewrite -> H. reflexivity.  Qed.
...
Proof.
  ...
  - simpl. Print mul_0_r. rewrite -> mul_0_r. reflexivity.
  - simpl. rewrite -> IHm'. 
  assert (H: forall a b, a * S b = a * b + a).
  { 
    intros. induction a as [| a' IHa'].
    - simpl. reflexivity.
    - simpl. rewrite -> IHa'. 
  ...
  rewrite -> H. rewrite -> add_comm. reflexivity.  Qed.
(** [] *)
